...
File : [ CSF-TDv v7.6.0 on Azure ] : Cisco_Secure_Firewall_Threat_Defense_Virtual-7.7.0-89.vhd.bz2<br>
...
28. **Subnet4Name**: CSF-TDv data2 interface will attach to this subnet.<br>
e.g. outside
